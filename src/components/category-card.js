...
const CategoryCard = ({data, text, category}) => {
    return (
        <Link to={`/products/${category}`} className="relative h-64 w-64 bg-gray-800 opacity-80 hover:opacity-90 cursor-pointer m-4 shadow-2xl border-2  border-slate-400">
